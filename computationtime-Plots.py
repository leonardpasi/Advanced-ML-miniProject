...
n_samples = [10, 500, 750, 1000, 1250, 1500, 1750, 2000, 2250, 2500]
n_features = [20]
n_itr = 5
...
# plots
# training time
plt.errorbar(n_samples, traintime_adaboost, yerr = std_traintime_adaboost, 
             uplims = True, 
             lolims = True,
             label ='AdaBoost')

plt.errorbar(n_samples, traintime_gauss, yerr = std_traintime_gauss, 
             uplims = True, 
             lolims = True,
             label ='GPC')
plt.errorbar(n_samples, traintime_svm, yerr = std_traintime_svm, 
             uplims = True, 
             lolims = True,
             label ='SVM')
plt.legend()
...
plt.savefig("TrainSamples.pdf",bbox_inches="tight")
plt.show()

# test time
plt.errorbar(n_samples, testtime_adaboost, yerr = std_testtime_adaboost, 
             uplims = True, 
             lolims = True,
             label ='AdaBoost')

plt.errorbar(n_samples, testtime_gauss, yerr = std_testtime_gauss, 
             uplims = True, 
             lolims = True,
             label ='GPC')
plt.errorbar(n_samples, testtime_svm, yerr = std_testtime_svm, 
             uplims = True, 
             lolims = True,
             label ='SVM')
plt.legend()
...
plt.savefig("TestSamples.pdf",bbox_inches="tight")
plt.show()
